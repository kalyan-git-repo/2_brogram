...
export default function WorkoutCard(props) {
  const { trainingPlan, workoutIndex, type, dayNum, icon, handleSave, handleComplete, savedWeights } = props
  const { warmup, workout } = trainingPlan || {}
  
  const [showExerciseDescription, setShowExerciseDescription] = useState(null)
  // const showExerciseDescription = { name: 'kalyan', description: 'iamonly32' }
